...
class RoundForm extends React.Component {
    constructor(props) {
      ...
      if (this.props.mode === AppMode.ROUNDS_LOGROUND) {
        ...
        this.state.date = this.props.startData.date.substr(0,10); //Correct date format
  ...
  handleChange = (event) => {
    ...
    handleSubmit = (event) => {
      ...
      delete roundData.faIcon; //Not part of round data
      delete roundData.btnLabel; //Not part of round data
